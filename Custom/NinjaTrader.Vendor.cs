...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	public partial class Indicator : NinjaTrader.Gui.NinjaScript.IndicatorRenderBase
	{
		...
		public OrderFlowVolumeProfile OrderFlowVolumeProfile(NinjaTrader.NinjaScript.Indicators.MarketProfileType profileType, NinjaTrader.NinjaScript.Indicators.MarketProfilePeriod profilePeriod, int sessions, Data.TradingHours tradingHoursInstance, NinjaTrader.NinjaScript.Indicators.MarketProfileResolution resolution, int valueAreaPercent, int initialBalanceMinutes)
		{
			return OrderFlowVolumeProfile(Input, profileType, profilePeriod, sessions, tradingHoursInstance, resolution, valueAreaPercent, initialBalanceMinutes);
		}

		public OrderFlowVolumeProfile OrderFlowVolumeProfile(ISeries<double> input, NinjaTrader.NinjaScript.Indicators.MarketProfileType profileType, NinjaTrader.NinjaScript.Indicators.MarketProfilePeriod profilePeriod, int sessions, Data.TradingHours tradingHoursInstance, NinjaTrader.NinjaScript.Indicators.MarketProfileResolution resolution, int valueAreaPercent, int initialBalanceMinutes)
		{
			if (cacheOrderFlowVP != null)
				for (int idx = 0; idx < cacheOrderFlowVP.Length; idx++)
					if (cacheOrderFlowVP[idx] != null &&
						cacheOrderFlowVP[idx].ProfileType == profileType &&
						cacheOrderFlowVP[idx].TradingHoursInstance == tradingHoursInstance &&
						cacheOrderFlowVP[idx].ProfilePeriod == profilePeriod &&
						cacheOrderFlowVP[idx].ProfilePeriodValue == sessions &&
						cacheOrderFlowVP[idx].Resolution == resolution &&
						cacheOrderFlowVP[idx].ValueArea == valueAreaPercent &&
						cacheOrderFlowVP[idx].InitialBalanceMinutes == initialBalanceMinutes &&
						cacheOrderFlowVP[idx].EqualsInput(input))
						return cacheOrderFlowVP[idx];
			return CacheIndicator<OrderFlowVolumeProfile>(new OrderFlowVolumeProfile() { ProfileType = profileType, ProfilePeriod = profilePeriod, ProfilePeriodValue = sessions, TradingHoursInstance = tradingHoursInstance, Resolution = resolution, ValueArea = valueAreaPercent, InitialBalanceMinutes = initialBalanceMinutes }, input, ref cacheOrderFlowVP);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	public partial class MarketAnalyzerColumn : MarketAnalyzerColumnBase
	{
		public Indicators.OrderFlowVolumeProfile OrderFlowVolumeProfile(NinjaTrader.NinjaScript.Indicators.MarketProfileType profileType, NinjaTrader.NinjaScript.Indicators.MarketProfilePeriod profilePeriod, int sessions, Data.TradingHours tradingHoursInstance, NinjaTrader.NinjaScript.Indicators.MarketProfileResolution resolution, int valueAreaPercent, int initialBalanceMinutes)
		{
		...
		public Indicators.OrderFlowVolumeProfile OrderFlowVolumeProfile(ISeries<double> input, NinjaTrader.NinjaScript.Indicators.MarketProfileType profileType, NinjaTrader.NinjaScript.Indicators.MarketProfilePeriod profilePeriod, int sessions, Data.TradingHours tradingHoursInstance, NinjaTrader.NinjaScript.Indicators.MarketProfileResolution resolution, int valueAreaPercent, int initialBalanceMinutes)
		{
			return indicator.OrderFlowVolumeProfile(input, profileType, profilePeriod, sessions, tradingHoursInstance, resolution, valueAreaPercent, initialBalanceMinutes);
		}
	}
