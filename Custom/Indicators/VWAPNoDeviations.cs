...
{
	public class VWAPNoDeviations : Indicator
	{
		double	iCumVolume			= 0;
		...
		void PlotDevOne()
		{
			...
			Draw.Region(this, "dev1", CurrentBar, 0, PlotVWAP1U, PlotVWAP1L, null, SD1AreaBrush, 0);
		}
		...
		void PlotDevTwo()
		{
			...
			Draw.Region(this, "dev2", CurrentBar, 0, PlotVWAP1U, PlotVWAP2U, null, SD2AreaBrush, 0);
			Draw.Region(this, "dev3", CurrentBar, 0, PlotVWAP1L, PlotVWAP2L, null, SD2AreaBrush, 0);
		}
		...
		void PlotDevThree()
		{
			...
			Draw.Region(this, "dev4", CurrentBar, 0, PlotVWAP2U, PlotVWAP3U, null, SD3AreaBrush, 0);
			Draw.Region(this, "dev5", CurrentBar, 0, PlotVWAP2L, PlotVWAP3L, null, SD3AreaBrush, 0);
		}
		...
		void PlotDevFour()
		{
			...
			Draw.Region(this, "dev6", CurrentBar, 0, PlotVWAP3U, PlotVWAP4U, null, SD4AreaBrush, 0);
			Draw.Region(this, "dev7", CurrentBar, 0, PlotVWAP3L, PlotVWAP4L, null, SD4AreaBrush, 0);
		}
		...
		void PlotDevFive()
		{
			...
			Draw.Region(this, "dev8", CurrentBar, 0, PlotVWAP4U, PlotVWAP5U, null, SD5AreaBrush, 0);
			Draw.Region(this, "dev9", CurrentBar, 0, PlotVWAP4L, PlotVWAP5L, null, SD5AreaBrush, 0);
		}
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private VWAPNoDeviations[] cacheVWAPNoDeviations;
		public VWAPNoDeviations VWAPNoDeviations()
		{
			return VWAPNoDeviations(Input);
		}

		public VWAPNoDeviations VWAPNoDeviations(ISeries<double> input)
		{
			if (cacheVWAPNoDeviations != null)
				for (int idx = 0; idx < cacheVWAPNoDeviations.Length; idx++)
					if (cacheVWAPNoDeviations[idx] != null &&  cacheVWAPNoDeviations[idx].EqualsInput(input))
						return cacheVWAPNoDeviations[idx];
			return CacheIndicator<VWAPNoDeviations>(new VWAPNoDeviations(), input, ref cacheVWAPNoDeviations);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.VWAPNoDeviations VWAPNoDeviations()
		{
			return indicator.VWAPNoDeviations(Input);
		}

		public Indicators.VWAPNoDeviations VWAPNoDeviations(ISeries<double> input )
		{
			return indicator.VWAPNoDeviations(input);
		}
	}
