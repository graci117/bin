...
using BltTriggerLinesColorRegion.Common;
#endregion

namespace BltTriggerLinesColorRegion.Common
{
    public enum MATypeBLT { EMA, HMA, SMA, TMA, VMA, WMA, DEMA, TEMA, VWMA, ZLEMA, LinReg }
...
namespace NinjaTrader.NinjaScript.Indicators
{
    ...
    public class BltTriggerLinesColorRegion : Indicator
    {
        #region Globals

        private MATypeBLT                  triggerMATypeBLT                   = MATypeBLT.LinReg;
        private int                     triggerPeriod                   = 80;
        private MATypeBLT                  averageMATypeBLT                   = MATypeBLT.EMA;
        ...
        protected override void OnStateChange()
        {
            switch (State)
            {
                case State.SetDefaults:
                    Name = "BltTriggerLinesColorRegion";
        ...
        public override string DisplayName
        {
            get { return string.Format("{0}({1},{2},{3},{4})", this.Name,
                    TriggerMATypeBLT, TriggerPeriod, AverageMATypeBLT, AveragePeriod); }
        }
        ...
        protected override void OnBarUpdate()
        {
            ...
            switch (TriggerMATypeBLT)
            {
                case MATypeBLT.EMA: Trigger[0] = EMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.HMA: Trigger[0] = HMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.SMA: Trigger[0] = SMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.TMA: Trigger[0] = TMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.WMA: Trigger[0] = WMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.DEMA: Trigger[0] = DEMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.TEMA: Trigger[0] = TEMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.VWMA: Trigger[0] = VWMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.ZLEMA: Trigger[0] = ZLEMA(Input, TriggerPeriod)[0]; break;
                case MATypeBLT.LinReg: Trigger[0] = LinReg(Input, TriggerPeriod)[0]; break;
            }

            switch (AverageMATypeBLT)
            {
                case MATypeBLT.EMA: Average[0] = EMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.HMA: Average[0] = HMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.SMA: Average[0] = SMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.TMA: Average[0] = TMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.WMA: Average[0] = WMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.DEMA: Average[0] = DEMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.TEMA: Average[0] = TEMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.VWMA: Average[0] = VWMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.ZLEMA: Average[0] = ZLEMA(Trigger, AveragePeriod)[0]; break;
                case MATypeBLT.LinReg: Average[0] = LinReg(Trigger, AveragePeriod)[0]; break;
            }
        ...
        [NinjaScriptProperty]
        [Display(Name = "TriggerMATypeBLT", GroupName = "Parameters", Order = 1)]
        public MATypeBLT TriggerMATypeBLT
        {
            get { return triggerMATypeBLT; }
            set { triggerMATypeBLT = value; }
        }
        ...
        [NinjaScriptProperty]
        [Display(Name = "AverageMATypeBLT", GroupName = "Parameters", Order = 3)]
        public MATypeBLT AverageMATypeBLT
        {
            get { return averageMATypeBLT; }
            set { averageMATypeBLT = value; }
        }
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private BltTriggerLinesColorRegion[] cacheBltTriggerLinesColorRegion;
		public BltTriggerLinesColorRegion BltTriggerLinesColorRegion(MATypeBLT triggerMATypeBLT, int triggerPeriod, MATypeBLT averageMATypeBLT, int averagePeriod, ColorStyle colorLines, bool drawArrows, int arrowOffset, Brush arrowUpColor, Brush arrowDownColor, bool colorRegion, int regionOpacity, Brush regionUpColor, Brush regionDownColor, bool soundAlert, string soundFile, Brush triggerRisingColor, Brush triggerFallingColor, Brush averageRisingColor, Brush averageFallingColor)
		{
			return BltTriggerLinesColorRegion(Input, triggerMATypeBLT, triggerPeriod, averageMATypeBLT, averagePeriod, colorLines, drawArrows, arrowOffset, arrowUpColor, arrowDownColor, colorRegion, regionOpacity, regionUpColor, regionDownColor, soundAlert, soundFile, triggerRisingColor, triggerFallingColor, averageRisingColor, averageFallingColor);
		}

		public BltTriggerLinesColorRegion BltTriggerLinesColorRegion(ISeries<double> input, MATypeBLT triggerMATypeBLT, int triggerPeriod, MATypeBLT averageMATypeBLT, int averagePeriod, ColorStyle colorLines, bool drawArrows, int arrowOffset, Brush arrowUpColor, Brush arrowDownColor, bool colorRegion, int regionOpacity, Brush regionUpColor, Brush regionDownColor, bool soundAlert, string soundFile, Brush triggerRisingColor, Brush triggerFallingColor, Brush averageRisingColor, Brush averageFallingColor)
		{
			if (cacheBltTriggerLinesColorRegion != null)
				for (int idx = 0; idx < cacheBltTriggerLinesColorRegion.Length; idx++)
					if (cacheBltTriggerLinesColorRegion[idx] != null && cacheBltTriggerLinesColorRegion[idx].TriggerMATypeBLT == triggerMATypeBLT && cacheBltTriggerLinesColorRegion[idx].TriggerPeriod == triggerPeriod && cacheBltTriggerLinesColorRegion[idx].AverageMATypeBLT == averageMATypeBLT && cacheBltTriggerLinesColorRegion[idx].AveragePeriod == averagePeriod && cacheBltTriggerLinesColorRegion[idx].ColorLines == colorLines && cacheBltTriggerLinesColorRegion[idx].DrawArrows == drawArrows && cacheBltTriggerLinesColorRegion[idx].ArrowOffset == arrowOffset && cacheBltTriggerLinesColorRegion[idx].ArrowUpColor == arrowUpColor && cacheBltTriggerLinesColorRegion[idx].ArrowDownColor == arrowDownColor && cacheBltTriggerLinesColorRegion[idx].ColorRegion == colorRegion && cacheBltTriggerLinesColorRegion[idx].RegionOpacity == regionOpacity && cacheBltTriggerLinesColorRegion[idx].RegionUpColor == regionUpColor && cacheBltTriggerLinesColorRegion[idx].RegionDownColor == regionDownColor && cacheBltTriggerLinesColorRegion[idx].SoundAlert == soundAlert && cacheBltTriggerLinesColorRegion[idx].SoundFile == soundFile && cacheBltTriggerLinesColorRegion[idx].TriggerRisingColor == triggerRisingColor && cacheBltTriggerLinesColorRegion[idx].TriggerFallingColor == triggerFallingColor && cacheBltTriggerLinesColorRegion[idx].AverageRisingColor == averageRisingColor && cacheBltTriggerLinesColorRegion[idx].AverageFallingColor == averageFallingColor && cacheBltTriggerLinesColorRegion[idx].EqualsInput(input))
						return cacheBltTriggerLinesColorRegion[idx];
			return CacheIndicator<BltTriggerLinesColorRegion>(new BltTriggerLinesColorRegion(){ TriggerMATypeBLT = triggerMATypeBLT, TriggerPeriod = triggerPeriod, AverageMATypeBLT = averageMATypeBLT, AveragePeriod = averagePeriod, ColorLines = colorLines, DrawArrows = drawArrows, ArrowOffset = arrowOffset, ArrowUpColor = arrowUpColor, ArrowDownColor = arrowDownColor, ColorRegion = colorRegion, RegionOpacity = regionOpacity, RegionUpColor = regionUpColor, RegionDownColor = regionDownColor, SoundAlert = soundAlert, SoundFile = soundFile, TriggerRisingColor = triggerRisingColor, TriggerFallingColor = triggerFallingColor, AverageRisingColor = averageRisingColor, AverageFallingColor = averageFallingColor }, input, ref cacheBltTriggerLinesColorRegion);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.BltTriggerLinesColorRegion BltTriggerLinesColorRegion(MATypeBLT triggerMATypeBLT, int triggerPeriod, MATypeBLT averageMATypeBLT, int averagePeriod, ColorStyle colorLines, bool drawArrows, int arrowOffset, Brush arrowUpColor, Brush arrowDownColor, bool colorRegion, int regionOpacity, Brush regionUpColor, Brush regionDownColor, bool soundAlert, string soundFile, Brush triggerRisingColor, Brush triggerFallingColor, Brush averageRisingColor, Brush averageFallingColor)
		{
			return indicator.BltTriggerLinesColorRegion(Input, triggerMATypeBLT, triggerPeriod, averageMATypeBLT, averagePeriod, colorLines, drawArrows, arrowOffset, arrowUpColor, arrowDownColor, colorRegion, regionOpacity, regionUpColor, regionDownColor, soundAlert, soundFile, triggerRisingColor, triggerFallingColor, averageRisingColor, averageFallingColor);
		}
