...
namespace NinjaTrader.NinjaScript.Indicators.Slayer
{
	public class SlayerVWAP : Indicator
	{
		double	iCumVolume			= 0;
		...
		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				...
				AddPlot(new Stroke(Brushes.Turquoise,DashStyleHelper.Solid,2), PlotStyle.Line, "PlotVWAP");
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private Slayer.SlayerVWAP[] cacheSlayerVWAP;
		public Slayer.SlayerVWAP SlayerVWAP()
		{
			return SlayerVWAP(Input);
		}

		public Slayer.SlayerVWAP SlayerVWAP(ISeries<double> input)
		{
			if (cacheSlayerVWAP != null)
				for (int idx = 0; idx < cacheSlayerVWAP.Length; idx++)
					if (cacheSlayerVWAP[idx] != null &&  cacheSlayerVWAP[idx].EqualsInput(input))
						return cacheSlayerVWAP[idx];
			return CacheIndicator<Slayer.SlayerVWAP>(new Slayer.SlayerVWAP(), input, ref cacheSlayerVWAP);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.Slayer.SlayerVWAP SlayerVWAP()
		{
			return indicator.SlayerVWAP(Input);
		}

		public Indicators.Slayer.SlayerVWAP SlayerVWAP(ISeries<double> input )
		{
			return indicator.SlayerVWAP(input);
		}
	}
